...
Timepicker.prototype = {
    init: function()
    {
        ...
        this._colonPos  = -1;
        this._visible   = false;
        this.tpDiv      = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all" style="width: 100px; display: none; position: absolute;z-index:1007;"></div>');
        this._generateHtml();
    },
    ...
    show: function (input)
    {
		...
		//
		//	modified by Jason Wang 826 Media Lab.
		//
		var dpDivZIndex = dpDiv.zIndex();
		this.tpDiv.css('zIndex',dpDivZIndex);
		//
		//	modified by Jason Wang 826 Media Lab.
		//
    },
