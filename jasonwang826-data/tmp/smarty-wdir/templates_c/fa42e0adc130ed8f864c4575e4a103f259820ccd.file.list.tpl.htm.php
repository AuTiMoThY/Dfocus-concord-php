<?php /* Smarty version Smarty-3.1.12, created on 2015-07-28 11:26:21
         compiled from "/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/faq/list.tpl.htm" */ ?>
<?php /*%%SmartyHeaderCode:104201095555b6f65d1f6419-05980474%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fa42e0adc130ed8f864c4575e4a103f259820ccd' => 
    array (
      0 => '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/faq/list.tpl.htm',
      1 => 1438023063,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '104201095555b6f65d1f6419-05980474',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55b6f65d66b5e2_79902915',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55b6f65d66b5e2_79902915')) {function content_55b6f65d66b5e2_79902915($_smarty_tpl) {?><?php if (!is_callable('smarty_function_pager')) include '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/jasonwang826/php/smarty-plugins/sys/function.pager.php';
?><!DOCTYPE html>
<html>
	<head>
...
"<?php if (isset($_GET['group_id'])&&$_GET['group_id']==$_smarty_tpl->tpl_vars['d']->value->id){?> selected<?php }?>><?php echo $_smarty_tpl->tpl_vars['d']->value->name;?>
</option>
						<?php } ?>
					</select>
					<button type="button" class="btn btn-primary btn-xs" onclick="location.href='../faq-group/'"><i class="fa fa-pencil"></i> 編輯分類</button>
				</li>
			</ul>
			<div class="pull-right" style="margin-bottom: 10px;">
				<button type="button" class="btn btn-primary btn-xs" onclick="location.href='./?action=new&group_id=<?php echo $_smarty_tpl->tpl_vars['group_id']->value;?>
