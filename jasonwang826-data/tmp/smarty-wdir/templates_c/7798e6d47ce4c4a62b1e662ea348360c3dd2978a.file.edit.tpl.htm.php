<?php /* Smarty version Smarty-3.1.12, created on 2015-07-28 11:27:26
         compiled from "/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/user/edit.tpl.htm" */ ?>
<?php /*%%SmartyHeaderCode:171211924455b6f69e48b883-60870382%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7798e6d47ce4c4a62b1e662ea348360c3dd2978a' => 
    array (
      0 => '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/user/edit.tpl.htm',
      1 => 1438023108,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '171211924455b6f69e48b883-60870382',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55b6f69e6aecb3_21382426',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55b6f69e6aecb3_21382426')) {function content_55b6f69e6aecb3_21382426($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/jasonwang826/php/Smarty-3.1.12/libs/plugins/modifier.date_format.php';
?><!DOCTYPE html>
<html>
	<head>
					...
					<div class="panel-body">
						...
						<div class="form-group">
							...
							<?php if ($_REQUEST['action']=='new'){?>
								<input type="text" name="account" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['account'];?>
" class="form-control validate[required,minSize[4],ajax[user-account]]">
							<?php }else{ ?>
								<div><?php echo $_smarty_tpl->tpl_vars['r']->value['account'];?>
</div>
							<?php }?>
						</div>
...
" class="form-control validate[required]">
						...
						<div class="form-group">
							<label>密碼</label>
							<input type="password" id="password" name="password" value="" class="form-control validate[<?php if ($_REQUEST['action']=='new'){?>required,<?php }?>minSize[4],custom[onlyLetterNumber]]">
						</div>

						<div class="form-group">
							<label>密碼確認</label>
							<input type="password" id="password_confirm" value="" class="form-control validate[<?php if ($_REQUEST['action']=='new'){?>required,<?php }?>minSize[4],custom[onlyLetterNumber],equals[password]">
						</div>

						<div class="form-group">
							<label>email</label>
							<input type="text" name="email" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['email'];?>
" class="form-control validate[required,minSize[4],custom[email]]">
						</div>

						<div class="form-group">
							<label>最後一次登入時間</label>
							<div><?php echo smarty_modifier_date_format($_smarty_tpl->tpl_vars['r']->value['last_login'],'%Y/%m/%d %H:%M');?>
</div>
						</div>
