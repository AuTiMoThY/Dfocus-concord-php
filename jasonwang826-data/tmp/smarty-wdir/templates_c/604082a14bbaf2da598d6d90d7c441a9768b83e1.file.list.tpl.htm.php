<?php /* Smarty version Smarty-3.1.12, created on 2015-07-30 13:08:37
         compiled from "/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/document/list.tpl.htm" */ ?>
<?php /*%%SmartyHeaderCode:98108104655b9b155341a06-15364141%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '604082a14bbaf2da598d6d90d7c441a9768b83e1' => 
    array (
      0 => '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/document/list.tpl.htm',
      1 => 1438023062,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '98108104655b9b155341a06-15364141',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55b9b15563a406_16713189',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55b9b15563a406_16713189')) {function content_55b9b15563a406_16713189($_smarty_tpl) {?><?php if (!is_callable('smarty_function_pager')) include '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/jasonwang826/php/smarty-plugins/sys/function.pager.php';
?><!DOCTYPE html>
<html>
	<head>
			...
			<ul class="search">
				<li>
					...
					<select name="category" class="search">
						<option value="開戶文件"<?php if ($_smarty_tpl->tpl_vars['category']->value=='開戶文件'){?> selected<?php }?>>開戶文件</option>
						<option value="交易文件"<?php if ($_smarty_tpl->tpl_vars['category']->value=='交易文件'){?> selected<?php }?>>交易文件</option>
						<option value="異動文件"<?php if ($_smarty_tpl->tpl_vars['category']->value=='異動文件'){?> selected<?php }?>>異動文件</option>
						<option value="公開資料"<?php if ($_smarty_tpl->tpl_vars['category']->value=='公開資料'){?> selected<?php }?>>公開資料</option>
					</select>
				</li>
			</ul>
			<div class="pull-right" style="margin-bottom: 10px;">
				<button type="button" class="btn btn-primary btn-xs" onclick="location.href='./?action=new&category=<?php echo rawurlencode($_smarty_tpl->tpl_vars['category']->value);?>
...
" /></td>
								...
								<td><?php echo $_smarty_tpl->tpl_vars['r']->value->stitle;?>
</td>
								<td class="ord" data-maxOrd="<?php echo $_smarty_tpl->tpl_vars['maxOrd']->value;?>
" data-id="<?php echo $_smarty_tpl->tpl_vars['r']->value->id;?>
" data-value="<?php echo $_smarty_tpl->tpl_vars['r']->value->ord;?>
"></td>
								<td class="enable" data-tovalue="<?php if ($_smarty_tpl->tpl_vars['r']->value->enable=='Y'){?>N<?php }else{ ?>Y<?php }?>" data-id="<?php echo $_smarty_tpl->tpl_vars['r']->value->id;?>
"><?php if ($_smarty_tpl->tpl_vars['r']->value->enable=='Y'){?>是<?php }else{ ?>否<?php }?></td>
								<td>
