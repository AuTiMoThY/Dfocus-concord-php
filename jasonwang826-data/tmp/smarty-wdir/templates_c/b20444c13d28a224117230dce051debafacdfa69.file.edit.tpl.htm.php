<?php /* Smarty version Smarty-3.1.12, created on 2015-07-30 13:14:50
         compiled from "/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/team/edit.tpl.htm" */ ?>
<?php /*%%SmartyHeaderCode:765536555b9b2caadc675-96448973%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b20444c13d28a224117230dce051debafacdfa69' => 
    array (
      0 => '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/team/edit.tpl.htm',
      1 => 1438023107,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '765536555b9b2caadc675-96448973',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55b9b2cad00ae8_30354203',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55b9b2cad00ae8_30354203')) {function content_55b9b2cad00ae8_30354203($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
  ...
  <div class="row">
	...
	<!--
		function onValidationComplete(f,v)	{
			var $editor=$('textarea[name="ldesc"');
			if($editor.val()=='')	{
				$('#ldesc').validationEngine('showPrompt','* 此欄位不可空白','error', undefined, true);
				v=false;
			}
			var $editor=$('textarea[name="rdesc"');
			if($editor.val()=='')	{
				$('#rdesc').validationEngine('showPrompt','* 此欄位不可空白','error', undefined, true);
				v=false;
			}
			return v;
		}
...
" class="form-control validate[required]">
						...
						<div class="form-group">
							<label>職位</label>
							<textarea name="job" rows="4" class="form-control validate[required]"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['r']->value['job'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
						</div>

						<div class="form-group">
							<label>圖片上傳</label>
							<input type="file" name="photo" class="validate[<?php if ($_REQUEST['action']=='new'){?>required,<?php }?>custom[image-file]] image-upload" preview-at="photo">
							尺寸 : 1920 px * 650 px
							<div src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['r']->value['photo'], ENT_QUOTES, 'UTF-8', true);?>
" id="photo" class="image-preview image-preview-crop" width="960" height="325"></div>
						</div>

						<div class="form-group">
							<label>列表縮圖</label>
							<input type="file" name="thumb" class="validate[<?php if ($_REQUEST['action']=='new'){?>required,<?php }?>custom[image-file]] image-upload" preview-at="thumb">
							尺寸 : 555 px * 700 px
							<div src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['r']->value['thumb'], ENT_QUOTES, 'UTF-8', true);?>
" id="thumb" class="image-preview image-preview-crop" width="555" height="700"></div>
						</div>

						<div class="form-group">
							<div><label>人物介紹 - 左半部</label></div>
							<div id="ldesc"></div>
							<textarea name="ldesc" rows="12" cols="80" class="html-editor"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['r']->value['ldesc'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
						</div>

						<div class="form-group">
							<div><label>人物介紹 - 右半部</label></div>
							<div id="rdesc"></div>
							<textarea name="rdesc" rows="12" cols="80" class="html-editor"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['r']->value['rdesc'], ENT_QUOTES, 'UTF-8', true);?>
</textarea>
						</div>
