<?php /* Smarty version Smarty-3.1.12, created on 2015-07-30 12:29:18
         compiled from "/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/advisory/edit.tpl.htm" */ ?>
<?php /*%%SmartyHeaderCode:135012810355b9a81ed30c90-57207992%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63a741d6de305e58a3db5030ac9a3b787fc81b9c' => 
    array (
      0 => '/var/www/vhosts/ecmd.com.tw/subdomains/case2/httpdocs/admin/advisory/edit.tpl.htm',
      1 => 1438023052,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '135012810355b9a81ed30c90-57207992',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_55b9a81f039ac6_29688715',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_55b9a81f039ac6_29688715')) {function content_55b9a81f039ac6_29688715($_smarty_tpl) {?><!DOCTYPE html>
<html>
	<head>
				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div class="form-group">
							<label>活動期間</label>
							<div>
								<input type="text" name="sdate" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['sdate'];?>
" placeholder="開始日期" class="form-control inline-block date">
								~
								<input type="text" name="edate" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['edate'];?>
" placeholder="結束日期" class="form-control inline-block date">
							</div>
						</div>
...
" id="icon" class="image-preview image-preview-crop" width="390" height="260"></div>
						</div>

						活動資訊
						<div class="form-group">
							<label>講師</label>
							<input type="text" name="lecturer" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['lecturer'];?>
" class="form-control validate[required]">
						</div>

						<div class="form-group">
							<label>嘉賓</label>
							<input type="text" name="guest" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['guest'];?>
" class="form-control">
						</div>

						<div class="form-group">
							<label>日期</label>
							<input type="text" name="date" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['date'];?>
" class="form-control validate[required]">
						</div>

						<div class="form-group">
							<label>時間</label>
							<input type="text" name="time" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['time'];?>
" class="form-control validate[required]">
						</div>

						<div class="form-group">
							<label>地點</label>
							<input type="text" name="location" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['location'];?>
" class="form-control validate[]">
						</div>

						<div class="form-group">
							<label>費用</label>
							<input type="text" name="price" value="<?php echo $_smarty_tpl->tpl_vars['r']->value['price'];?>
